...
func LoadKeyFromFileInteractive(filename string) (*[32]byte, error) {
	...
	if a.Size() < 72 { // there can't be a password...
...
// in the clear.
func SaveKeyToFileInteractive(filename string, priv *[32]byte) error {
	var match bool
	var err error
...
func SaveKeyToFileArg(filename string, priv *[32]byte, pass []byte) error {
